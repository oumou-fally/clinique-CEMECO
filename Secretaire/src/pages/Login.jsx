        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-linear-to-r from-teal-600 to-green-600 text-white font-semibold py-3 rounded-lg hover:shadow-lg transform hover:scale-105 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <div className="border-t border-gray-200 pt-4 space-y-2">
              ...
              <p className="text-xs text-center">
                ...
                <span className="font-mono text-teal-600">secretaire@clinic.com</span>
              </p>
              <p className="text-xs text-center">
                <span className="text-gray-600">Mot de passe:</span>{' '}
                <span className="font-mono text-teal-600">secretaire123</span>
              </p>
            </div>
          </form>
        </div>
