...
// Composant : Page des paramètres du compte utilisateur
export default function ParametresCompte() {
  ...
  // État des préférences de notifications (activées/désactivées)
  ...
  // Fonction qui inverse l'état d'une notification (toggle)
  ...
  return (
    <Layout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Menu latéral de navigation des paramètres */}
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            {/* Les différents paramètres de notification sont gérés ici */}
            <div className="space-y-4">
              {/* Chaque bloc = une préférence activable/désactivable */}
            </div>
          </div>
