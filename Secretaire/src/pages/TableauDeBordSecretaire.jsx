...
export default function TableauDeBordSecretaire() {
  ...
  const stats = [
    ...
    },
    {
      ...
      details: '3 en consultation, 2 en pause'
    },
    {
  ...
  // =========================
  // FONCTION DE COULEUR DES STATUTS
  // =========================
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          ...
          <div className="space-y-2">
            ...
            <button className="w-full bg-blue-100 text-blue-700 py-3 rounded-lg">
              Emploi du Temps
            </button>
            <button className="w-full bg-purple-100 text-purple-700 py-3 rounded-lg">
              Facturation
            </button>
            <button className="w-full bg-orange-100 text-orange-700 py-3 rounded-lg">
              Gestion Médecins
            </button>
          </div>
        </div>
